...
def QWEN3_5_MAXTEXT_TO_HF_PARAM_MAPPING(config, maxtext_config, scan_layers=False):
  ...
  # Dense Qwen3.5 variants (e.g. Qwen3.5-27B) have no experts in their HF
  # config; their MLP is a standard SwiGLU block (MaxText MlpBlock wi_0/wi_1/wo).
  is_moe = int(config["text_config"].get("num_experts") or 0) > 1
  ...
  if scan_layers:
    ...
    for block_idx in range(layer_cycle_interval):
      ...
      if is_moe:
        ...
        # 3/4. Dense MLP (standard SwiGLU MlpBlock, maps like dense Qwen3)
        mapping.update(
            {
    ...
    for i in range(num_main_layers):
      ...
      if is_moe:
        ...
        # Dense MLP (standard SwiGLU MlpBlock, maps like dense Qwen3)
        mapping.update(
            {
...
def QWEN3_5_MAXTEXT_TO_HF_PARAM_HOOK_FN(config, maxtext_config, scan_layers=False, saving_to_hf=False):
  ...
  for i in loop_indices:
    ...
    if int(text_cfg.get("num_experts") or 0) > 1:
      ...
      # Dense MLP (standard SwiGLU MlpBlock): plain 2-D kernels, HF <-> MT transpose
