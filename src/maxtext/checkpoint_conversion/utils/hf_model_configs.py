...
# from https://huggingface.co/Qwen/Qwen3.5-27B/blob/main/config.json
# Dense Qwen3.5: same hybrid GDN/full-attention text stack as the MoE
# variants, standard dense SwiGLU MLP (no num_experts / moe fields).
qwen3_5_27b_dict = {
    ...
    "text_config": {
        ...
        "intermediate_size": 17408,
        "layer_types": [
            "linear_attention" if (i + 1) % 4 else "full_attention" for i in range(64)
        ],
        "linear_conv_kernel_dim": 4,
        "linear_key_head_dim": 128,
        "linear_num_key_heads": 16,
...
try:
  # Will execute successfully if Transformers is updated with dense Qwen3.5 support
  qwen3_5_27b_config = transformers.Qwen3_5Config(**qwen3_5_27b_dict)
except AttributeError:
  qwen3_5_27b_config = PTConfig(**qwen3_5_27b_dict)  # pytype: disable=wrong-arg-types
...
HF_MODEL_CONFIGS = {
    ...
    "qwen3.5-27b": qwen3_5_27b_config,
